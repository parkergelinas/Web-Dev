  ...
  ammAll.forEach((item) => {
    ...
    if (
      ammLayout.pcMintAddress.toString() ===
        ammLayout.serumMarket.toString() /** How could the pair coin mint be = serum dex program?? */ ||
      ammLayout.lpMintAddress.toString() ===
        "11111111111111111111111111111111" /** How could the lp coin mint be = system program?? */
    ) {
      return;
    }
